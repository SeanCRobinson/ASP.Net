...
<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CustomerConnectionString1 %>" DeleteCommand="DELETE FROM [Customer] WHERE [CustomerID] = @CustomerID" InsertCommand="INSERT INTO [Customer] ([CustomerID], [FirstName], [LastName], [Address], [City], [State], [Zip], [Phone], [EMail]) VALUES (@CustomerID, @FirstName, @LastName, @Address, @City, @State, @Zip, @Phone, @EMail)" ProviderName="<%$ ConnectionStrings:CustomerConnectionString1.ProviderName %>" SelectCommand="SELECT [CustomerID], [FirstName], [LastName], [Address], [City], [State], [Zip], [Phone], [EMail] FROM [Customer]" UpdateCommand="UPDATE [Customer] SET [FirstName] = @FirstName, [LastName] = @LastName, [Address] = @Address, [City] = @City, [State] = @State, [Zip] = @Zip, [Phone] = @Phone, [EMail] = @EMail WHERE [CustomerID] = @CustomerID">
        <DeleteParameters>
